...
const HeaderV3 = () => {
    ...
    return (
        <>
            <header>
                <nav className={`navbar mobile-sidenav dark-layout brand-center navbar-default validnavs on menu-center no-full ${isMenuSticky ? "sticked" : ""}`}>
                    ...
                    <div className="container">
                        <div className="navbar-header">
                            ...
                            <Link className="navbar-brand" href="/">
                                <Image src="/assets/img/logo.png" width={675} height={332} className="logo logo-display" alt="Logo" />
                        ...
                        <div className={`collapse navbar-collapse collapse-mobile ${isOpen ? "show" : ""}`} id="navbar-menu">
                            ...
                            <div className="col-half left">
                                <ul className="nav navbar-nav navbar-center navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
                                    ...
                                    <li className={`dropdown ${isMenuOpen('pages-left') ? 'on' : ''}`}>
                                        <Link
                                            href="#"
                                            className="dropdown-toggle"
                                            data-toggle="dropdown"
                                        ...
                                        >
                                            ...
                                            <li className={`dropdown ${isMenuOpen('pages-left-sub') ? 'on' : ''}`}>
                                                <Link
                                                    href="#"
                                                    className="dropdown-toggle"
                                                    data-toggle="dropdown"
                                                ...
                                                <ul
                                                    className="dropdown-menu animated"
                                                    style={getMenuStyle('pages-left-sub')}
                                                >
                                                    <li><Link href="/about-us">About Us</Link></li>
                                                    <li><Link href="/chef">Chef</Link></li>
                                                    <li><Link href="/chef-details/1">Chef Details</Link></li>
                                                    ...
                                                    <li><Link href="/login">Login</Link></li>
                                                    <li><Link href="/not-found">Error Page</Link></li>
                                                    <li className={`dropdown ${isMenuOpen('pages-left-dark') ? 'on' : ''}`}>
                                                        <Link
                                                            href="#"
                                                            className="dropdown-toggle"
                                                            data-toggle="dropdown"
                                                        ...
                                                        <ul
                                                            ...
                                                            style={getMenuStyle('pages-left-dark')}
                                                        >
                                    ...
                                    <li className={`dropdown ${isMenuOpen('menu-left') ? 'on' : ''}`}>
                                        <Link
                                            href="#"
                                            className="dropdown-toggle"
                                            data-toggle="dropdown"
                                        ...
                                        >
                                            ...
                                            <li className={`dropdown ${isMenuOpen('menu-left-dark') ? 'on' : ''}`}>
                                                <Link
                                                    href="#"
                                                    className="dropdown-toggle"
                                                    data-toggle="dropdown"
                                                ...
                                                <ul
                                                    className="dropdown-menu"
                                                    style={getMenuStyle('menu-left-dark')}
                                                >
                            ...
                            <div className="col-half right">
                                <ul className="nav navbar-nav navbar-right">
                                    <li className={`dropdown ${isMenuOpen('blog-right') ? 'on' : ''}`}>
                                        <Link
                                            href="#"
                                            className="dropdown-toggle"
                                            data-toggle="dropdown"
                                        ...
                                        >
                                            ...
                                            <li className={`dropdown ${isMenuOpen('blog-right-dark') ? 'on' : ''}`}>
                                                <Link
                                                    href="#"
                                                    className="dropdown-toggle"
                                                    data-toggle="dropdown"
                                                ...
                                                <ul
                                                    className="dropdown-menu"
                                                    style={getMenuStyle('blog-right-dark')}
                                                >
                                    ...
                                    <li className={`dropdown ${isMenuOpen('shop-right') ? 'on' : ''}`}>
                                        <Link
                                            href="#"
                                            className="dropdown-toggle"
                                            data-toggle="dropdown"
                                        ...
                                        >
                                            ...
                                            <li className={`dropdown ${isMenuOpen('shop-right-dark') ? 'on' : ''}`}>
                                                <Link
                                                    href="#"
                                                    className="dropdown-toggle"
                                                    data-toggle="dropdown"
                                                ...
                                                <ul
                                                    className="dropdown-menu"
                                                    style={getMenuStyle('shop-right-dark')}
                                                >
