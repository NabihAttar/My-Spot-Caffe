                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="login-thumb">
                                    <Image src='/assets/img/thumb/14.jpg' width={1500} height={1500} alt="Image Not Found" />
                                    <div className="logo">
                                        <Link href="/">
                                            <Image src="/assets/img/logo-light.png" width={675} height={332} alt="Image Not Found" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
