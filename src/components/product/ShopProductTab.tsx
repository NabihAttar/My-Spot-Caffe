                            ...
                            <div className="tab-pane fade" id="review-tab" role="tabpanel" aria-labelledby="review-tab-control">
                                ...
                                <div className="review-form">
                                    ...
                                    <div className="rating-select">
                                        <div className="stars">
                                            <span>
                                                <Link className="star-1" href="#" scroll={false}><i className="fas fa-star"></i></Link>
                                                <Link className="star-2" href="#" scroll={false}><i className="fas fa-star"></i></Link>
                                                <Link className="star-3" href="#" scroll={false}><i className="fas fa-star"></i></Link>
                                                <Link className="star-4" href="#" scroll={false}><i className="fas fa-star"></i></Link>
                                                <Link className="star-5" href="#" scroll={false}><i className="fas fa-star"></i></Link>
                                            </span>
                                        </div>
                                    </div>
                                    <ProductReviewForm />
